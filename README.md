...
Веб-приложение для бронирования аудиторий. Гости могут просматривать список аудиторий, зарегистрированные пользователи - создавать и отменять свои брони, администратор - управлять аудиториями, оборудованием и заявками на бронирование.
...
12. Открыть `/admin/bookings`, проверить список заявок и отмену бронирования.
